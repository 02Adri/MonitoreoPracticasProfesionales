...
import { chevronBackOutline,addCircleOutline,eyeOutline, home,readerOutline, documentOutline } from 'ionicons/icons';
...
export class CrearInformeEstudiantePage implements OnInit {
  ...
  private datosGuardados=this.loginEs.obtenerDatosLocalStorage()
    ...
    addIcons({chevronBackOutline,addCircleOutline,eyeOutline,readerOutline,documentOutline})
  }
